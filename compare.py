...
from network import calculate_minf1, calculate_minf2

model = keras.models.load_model("my_regression_model2500x2.keras")
df = pd.read_csv("generated_data/training_data_2500x2.csv")
samples = df.sample(5)
